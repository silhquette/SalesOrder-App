    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ isset($create) ? route('customer.store') : route('customer.update', $customer->code) }}" id="input-form">
                        <div class="flex justify-center mt-4">
                            <div class=" grid lg:grid-cols-6 grid-cols-2 gap-6 lg:w-2/3 w-full">
                                @csrf
                                @if (!isset($create))
                                    @method('PATCH')
                                @endif
                                <!-- Customer Code -->
                                <div class="mx-4 lg:col-span-3">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-8 lg:w-fit w-full">
                <div class="p-6 text-gray-900 py-4 lg:w-fit w-full flex items-center hover:text-[#144272]">
