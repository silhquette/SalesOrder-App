<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex w-full">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center">
                        ...
                        <span class="ml-2 font-semibold">PT. BUMI ISAM MANDIRI</span>
                    </a>
                </div>

                <!-- Navigation Links -->
                <div class="hidden sm:-my-px sm:ml-10 sm:flex w-full items-center gap-3 justify-center">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('document.index')" :active="request()->routeIs('document*')">
                {{ __('Document') }}
            </x-responsive-nav-link>
        </div>
